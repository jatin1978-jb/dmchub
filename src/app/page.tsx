      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b border-[#C5A059]/25 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="w-full max-w-[1650px] mx-auto px-6 sm:px-10 lg:px-16">
          <div className="flex items-center justify-between h-24 lg:h-28">
            ...
            <nav aria-label="Main navigation" className="hidden xl:flex items-center gap-10">
            ...
            <div className="hidden lg:flex items-center gap-5">
              <Link
                href="/auth/login"
                className="text-base font-bold text-[#0B1B2D] hover:text-[#C5A059] px-3 py-2 transition-colors"
              >
                Sign In
              </Link>
              <Link
                href="/auth/register/agent"
                className="text-base font-bold px-6 py-3 rounded-xl border-2 border-[#C5A059] text-[#0B1B2D] hover:bg-[#C5A059]/10 transition-all duration-150"
              >
                Join as Travel Agent
              </Link>
              <Link
                href="/auth/register/dmc"
                className="text-base font-bold px-7 py-3 rounded-xl bg-[#0B1B2D] text-white hover:bg-[#162B44] shadow-md shadow-[#0B1B2D]/20 transition-all duration-150"
              >
                Join as a DMC
              </Link>
            </div>
                ...
                <div className="lg:col-span-5">
                  <div className="relative rounded-3xl p-8 bg-[#0B1B2D] text-white border-2 border-[#C5A059]/40 shadow-2xl shadow-[#0B1B2D]/30 overflow-hidden">
                    ...
                    <div className="pt-4 border-t border-slate-700 text-center">
                      <Link href="/auth/register/agent" className="text-sm font-bold text-[#C5A059] hover:underline inline-flex items-center gap-2">
