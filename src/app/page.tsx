  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-[#0F172A] flex flex-col font-sans selection:bg-[#C5A059]/20 selection:text-[#0B1B2D] overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 border-b border-[#C5A059]/25 bg-white/95 backdrop-blur-md shadow-sm">
        <div className="w-full max-w-[1650px] mx-auto px-4 sm:px-8 lg:px-12">
          <div className="flex items-center justify-between min-h-[100px] lg:min-h-[120px] py-3">
            ...
            <nav aria-label="Main navigation" className="hidden lg:flex items-center gap-8 xl:gap-10 ml-auto">
              <a href="#about" className="text-sm sm:text-base font-semibold text-[#0B1B2D] hover:text-[#C5A059] transition-colors">
                What is DMCXchange
              </a>
              <a href="#how-it-works" className="text-sm sm:text-base font-semibold text-[#0B1B2D] hover:text-[#C5A059] transition-colors">
                How it works
              </a>
              <a href="#about" className="text-sm sm:text-base font-semibold text-[#0B1B2D] hover:text-[#C5A059] transition-colors">
                About us
              </a>
              <a href="#contact" className="text-sm sm:text-base font-semibold text-[#0B1B2D] hover:text-[#C5A059] transition-colors">
                Contact us
              </a>
            </nav>
            ...
            <button
              ...
              className="lg:hidden p-2.5 rounded-xl border border-slate-200 text-[#0B1B2D] hover:bg-slate-100 transition-colors ml-auto"
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden bg-white border-b border-[#C5A059]/30 px-6 py-5 space-y-3 shadow-xl animate-in fade-in slide-in-from-top-2">
            <nav className="flex flex-col gap-3 text-base font-semibold text-[#0B1B2D]">
              ...
              <a href="#about" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#C5A059] py-1.5 border-b border-slate-100">About us</a>
              <a href="#contact" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#C5A059] py-1.5 border-b border-slate-100">Contact us</a>
            </nav>
          </div>
        )}
      </header>
      ...
      <div className="pt-32 sm:pt-36 lg:pt-40">
        <main>
          ...
          {/* Hero Section */}
          <section className="relative min-h-[80vh] flex flex-col justify-center overflow-hidden bg-gradient-to-b from-[#F8FAFC] via-[#F1F5F9] to-white py-12 lg:py-20" aria-label="Hero">
            {/* Subtle Grid Pattern */}
            ...
            <div className="relative z-10 w-full max-w-[1650px] mx-auto px-6 sm:px-10 lg:px-12">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
                ...
                {/* Right Column: LIVE LOGIN CARD (Replacing Image 1 with Image 2 in DMC Theme) */}
                <div className="lg:col-span-5">
                  <div className="relative rounded-2xl p-6 sm:p-8 bg-[#0B1B2D] text-white border-2 border-[#C5A059]/50 shadow-2xl overflow-hidden">
                    <div className="absolute -right-16 -top-16 w-40 h-40 bg-[#C5A059]/20 rounded-full blur-3xl" />
                    
                    {/* Header */}
                    <div className="mb-6">
                      <h3 className="text-2xl font-bold font-serif text-white mb-1">Login to your account</h3>
                      <p className="text-xs text-slate-300">Select your account type and enter credentials to continue</p>
                    </div>

                    {/* Role Selector Tabs (DMC vs Travel Agent) */}
                    <div className="grid grid-cols-2 gap-2 p-1 bg-[#162B44] rounded-xl border border-slate-700 mb-6">
                      <button
                        type="button"
                        onClick={() => handleRoleSwitch('DMC')}
                        className={`flex items-center justify-center gap-2 py-2.5 rounded-lg text-xs font-bold transition-all ${
                          loginRole === 'DMC'
                            ? 'bg-[#C5A059] text-[#0B1B2D] shadow-md'
                    ...
                    {/* Error Alert */}
                    {loginError && (
                      <div className="mb-4 p-3 bg-red-950/80 border border-red-500/50 rounded-xl flex items-center gap-2.5 text-red-300 text-xs animate-in fade-in">
                    ...
                    <form onSubmit={handleHeroLogin} className="space-y-4">
                      ...
                      <div className="space-y-1.5">
                        <label className="text-xs font-semibold text-slate-200 block">Email / Username</label>
                        <div className="relative">
                          ...
                          <input
                            ...
                            required
                            className="w-full bg-[#162B44] border border-slate-700 rounded-xl pl-10 pr-4 py-3 text-sm text-white placeholder-slate-400 focus:outline-none focus:border-[#C5A059] transition-all"
                          />
                        </div>
                      </div>
                      ...
                      <div className="space-y-1.5">
                        <div className="flex items-center justify-between">
                          ...
                          <a href="#" className="text-xs text-[#C5A059] hover:underline font-medium">Forgot Password?</a>
                        </div>
                        <div className="relative">
                          ...
                          <input
                            ...
                            required
                            className="w-full bg-[#162B44] border border-slate-700 rounded-xl pl-10 pr-10 py-3 text-sm text-white placeholder-slate-400 focus:outline-none focus:border-[#C5A059] transition-all"
                          />
                          <button
                            type="button"
                      ...
                      <button
                        ...
                        className="w-full bg-[#C5A059] text-[#0B1B2D] font-bold text-sm hover:bg-[#D4AF37] shadow-lg py-3.5 rounded-xl transition-all flex items-center justify-center gap-2 mt-2"
                      >
                    ...
                    <div className="mt-6 pt-5 border-t border-slate-800 text-center text-xs text-slate-300">
          ...
          <section id="how-it-works" className="py-16 lg:py-24 bg-white border-t border-slate-200">
            <div className="w-full max-w-[1650px] mx-auto px-6 sm:px-10 lg:px-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10">
                ...
                <div className="bg-[#F8FAFC] p-6 sm:p-9 rounded-2xl border border-slate-200 luxury-card-shadow flex flex-col justify-between">
                  <div>
                    <div className="mb-6">
                      <span className="text-xs font-bold tracking-widest uppercase px-3 py-1 rounded border border-slate-200 text-slate-600 bg-slate-200">
                        For Travel Agents
                      </span>
                    </div>
          ...
          <section id="contact" className="py-16 lg:py-24 bg-[#F8FAFC] border-t border-b border-slate-200">
            <div className="w-full max-w-[1650px] mx-auto px-6 sm:px-10 lg:px-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
                <div className="bg-white p-6 rounded-2xl border border-slate-200 luxury-card-shadow flex items-start gap-4">
                  <div className="w-10 h-10 rounded-xl bg-[#0B1B2D] text-[#C5A059] flex items-center justify-center shrink-0">
                    <Mail className="w-5 h-5" />
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-[#0B1B2D] font-serif mb-1">Email Support</h4>
                    <p className="text-xs text-slate-600">support@dmcxchange.com</p>
                    <p className="text-xs text-slate-600">partnerships@dmcxchange.com</p>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 luxury-card-shadow flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-[#0B1B2D] font-serif mb-1">Global Desk</h4>
                    <p className="text-xs text-slate-600">+1 (800) 555-DMCX</p>
                    <p className="text-xs text-slate-600">24/7 B2B Marketplace Support</p>
                  </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 luxury-card-shadow flex items-start gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-[#0B1B2D] font-serif mb-1">Headquarters</h4>
                    <p className="text-xs text-slate-600">DMCXchange Global Network</p>
                    <p className="text-xs text-slate-600">Global Travel Marketplace Hub</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <footer className="bg-[#061121] border-t border-[#C5A059]/20 py-16 text-slate-400 text-xs">
        <div className="w-full max-w-[1650px] mx-auto px-6 sm:px-10 lg:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#C5A059] mb-4">Navigation</h4>
            ...
            <div>
              <h4 className="text-xs font-bold uppercase tracking-widest text-[#C5A059] mb-4">Portals & Accounts</h4>
              <ul className="space-y-2.5 text-xs">
